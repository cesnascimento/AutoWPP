...
urlpatterns = [
    ...
    path('group/<int:group_id>/add-people/', add_people_to_group_view, name='add_people_to_group'),
    path('group/<int:group_id>/submit-add-people/', submit_add_people_to_group_view, name='submit_add_people'),
    path('group/<int:group_id>/ajax-invite-link/', generate_invite_link_ajax, name='generate_invite_link_ajax'),
    path('group/<int:group_id>/upload-photo/', upload_group_photo_view, name='upload_group_photo'),
    path('group/<int:group_id>/send-message/', send_message_view, name='send_message'),
